                             ...
                             x264_picture_t *pic_out )
{
    ...
    *pp_nal = NULL;
	...
	//	__android_log_print(ANDROID_LOG_ERROR, "encoder.c", "pic in not  null");
        ...
        {
		//	__android_log_print(ANDROID_LOG_ERROR, "encoder.c", "nothing yet to encode ,wait for filling of buffers");
    ...
    {
	//	__android_log_print(ANDROID_LOG_ERROR, "encoder.c", "pic in null");
    ...
    h->i_frame++;
	//__android_log_print(ANDROID_LOG_ERROR, "encoder.c", "h->frames.current:%d",h->frames.current[0]);
	...
	//__android_log_print(ANDROID_LOG_ERROR, "encoder.c", "get frame to be encoded");
